...
func (keyRepository) RotateKey(ctx context.Context, _ models.RotateKeyRequest) (*models.KeyData, error) {
	return runWithContext(ctx, func() (*models.KeyData, error) {
		return nil, errors.New("local: key rotation is not supported")
	})
}

func (keyRepository) GetKey(ctx context.Context, _ models.GetKeyRequest) (*models.KeyData, error) {
	return runWithContext(ctx, func() (*models.KeyData, error) {
		return nil, errors.New("local: key metadata lookup is not supported")
	})
}

func (keyRepository) DeactivateKey(ctx context.Context, _ models.DeactivateKeyRequest) error {
	if err := contextErr(ctx); err != nil {
		return err
	}
...
// form.
func (symmetricRepository) GenerateSymetrycKeys(ctx context.Context, input models.GenerateSymmetricKeyRequest) (*models.KeyData, error) {
	return runWithContext(ctx, func() (*models.KeyData, error) {
...
func (symmetricRepository) EncryptAES(ctx context.Context, input models.EncryptAESRequest) (string, error) {
...
func (symmetricRepository) DecryptAES(ctx context.Context, input models.DecryptAESRequest) (string, error) {
	return runWithContext(ctx, func() (string, error) {
...
func (asymmetricRepository) GenerateRSAKeys(ctx context.Context, input models.GenerateRSAKeyRequest) (*models.KeyData, error) {
	return runWithContext(ctx, func() (*models.KeyData, error) {
...
// Base64.
func (asymmetricRepository) GenerateECDHCurveKeys(ctx context.Context, input models.GenerateECDHCurveKeyRequest) (*models.KeyData, error) {
	return runWithContext(ctx, func() (*models.KeyData, error) {
		curveImpl, err := utilities.ResolveECDHCurve(input.Curve)
		if err != nil {
			return nil, err
		}
...
// public key.
func (asymmetricRepository) RSA_OAEP_Encode(ctx context.Context, input models.RSAOAEPEncodeRequest) (string, error) {
	return runWithContext(ctx, func() (string, error) {
...
// encoded private key.
func (asymmetricRepository) RSA_OAEP_Decode(ctx context.Context, input models.RSAOAEPDecodeRequest) (string, error) {
	return runWithContext(ctx, func() (string, error) {
