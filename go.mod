...
// Use https://github.com/PointerByte/forge-go instead.
...
require (
	...
	github.com/PointerByte/GoForge/security v0.0.69
...
require (
	github.com/PointerByte/GoForge/encrypt v0.0.44 // indirect
