...
// Use https://github.com/PointerByte/forge-go/security instead.
...
require (
	github.com/PointerByte/GoForge/encrypt v0.0.44
...
require (
	github.com/PointerByte/GoForge/logger v0.0.62 // indirect
